...
# as 0644 and posix_spawnp fails at runtime with "posix_spawnp failed" the first
# time a terminal session is opened. Re-mark every prebuilt helper executable.
