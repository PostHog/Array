...
import { SITUATIONS } from "@shared/types/workflow";
...
export function ConfigMap() {
  ...
  const saveMutation = useMutation(trpc.workflow.save.mutationOptions());
  const resetMutation = useMutation(
    trpc.workflow.resetToDefault.mutationOptions(),
  );
