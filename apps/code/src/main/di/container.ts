...
import { CheckpointService } from "@posthog/workspace-server/services/checkpoint/service";
...
container.bind(CHECKPOINT_SERVICE).to(CheckpointService).inSingletonScope();
