...
2. Validate the complete source project with the canvas build tool. Do not
   supply a custom build command.
...
5. Publish exactly once in this run with the complete source project, the task
   and run attribution, and `expectedCurrentVersionId`.
