...
- Drive and screenshot the real running app (live data) with agent-browser over CDP `:9222`: run `pnpm app:cdp`, or use the `test-electron-app` (drive/interact) and `screenshot-dev-app` (capture) skills.
