...
- Drive the real running app (live data) with agent-browser over CDP `:9222`: run `pnpm app:cdp`, or use the `test-electron-app` skill. Use the Vite preview (`screenshot-dev-app`) for mocked layout-only checks.
