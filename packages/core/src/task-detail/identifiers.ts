...
export const TASK_CREATION_EFFECTS = Symbol.for(
  "posthog.core.taskDetail.creationEffects",
);
export const WORKSPACE_SETUP_SAGA = Symbol.for(
  "posthog.core.taskDetail.workspaceSetupSaga",
);
