...
const FREEFORM_BASE = [
  ...
  '- `ph.openExternal(url)` asks the host to open an absolute `http:`, `https:`, or `mailto:` URL after scheme validation. Use it for links that leave the canvas; sandboxed `target="_blank"` navigation is intentionally blocked.',
