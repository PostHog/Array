...
export const canvasCapabilitiesSchema = z.object({
  posthog: z.object({
    /** Saved insight short ids the canvas may load. */
    insights: z.array(z.string()),
    /** Whether the canvas may execute ad-hoc inline queries. */
    inlineQueries: z.boolean(),
    /** Event names the canvas may capture. */
    captureEvents: z.array(z.string()),
  }),
  network: z.object({
    /** External origins the artifact may connect to. */
