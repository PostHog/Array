...
/**
 * Model picker entry. Plan-restricted models (free-tier model gate) render
 * dimmed with a lock; picking one is intercepted by the selector's change
 * handler, which opens the upgrade gate instead of selecting.
 */
