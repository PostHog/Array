import {
  ...
  countUpForReview,
  deriveEnabledProducts,
  filterReportsBySearch,
} from "@posthog/core/inbox/reportFilters";
import { ANALYTICS_EVENTS, isDismissalReasonSnooze } from "@posthog/shared";
import type {
  SignalReport,
...
import { MultiSelectStack } from "@posthog/ui/features/inbox/components/detail/MultiSelectStack";
import {
  SelectReportPane,
  SkeletonBackdrop,
  WarmingUpPane,
} from "@posthog/ui/features/inbox/components/InboxEmptyStates";
import { InboxSetupPane } from "@posthog/ui/features/inbox/components/InboxSetupPane";
import { InboxSourcesDialog } from "@posthog/ui/features/inbox/components/InboxSourcesDialog";
import { GitHubConnectionBanner } from "@posthog/ui/features/inbox/components/list/GitHubConnectionBanner";
import { ReportListPane } from "@posthog/ui/features/inbox/components/list/ReportListPane";
import { SignalsToolbar } from "@posthog/ui/features/inbox/components/list/SignalsToolbar";
import {
  inboxBulkSnoozeDisabledReason,
  inboxBulkSuppressDisabledReason,
  useInboxBulkActions,
} from "@posthog/ui/features/inbox/hooks/useInboxBulkActions";
import { useInboxDeepLinkListSync } from "@posthog/ui/features/inbox/hooks/useInboxDeepLinkListSync";
import { useInboxEngagementTracker } from "@posthog/ui/features/inbox/hooks/useInboxEngagementTracker";
import {
...
import { useSeedSuggestedReviewerFilter } from "@posthog/ui/features/inbox/hooks/useSeedSuggestedReviewerFilter";
...
import { useInboxSignalsSidebarStore } from "@posthog/ui/features/inbox/stores/inboxSignalsSidebarStore";
import { INBOX_REFETCH_INTERVAL_MS } from "@posthog/ui/features/inbox/utils/inboxConstants";
import { setPendingInboxOpenMethod } from "@posthog/ui/features/inbox/utils/pendingInboxOpenMethod";
import {
  useIntegrations,
...
export function InboxSignalsTab() {
  ...
  const enabledProducts = useMemo(
    () => deriveEnabledProducts(signalSourceConfigs ?? []),
    [signalSourceConfigs],
  );
  ...
  const readyCount = useMemo(() => countUpForReview(allReports), [allReports]);
