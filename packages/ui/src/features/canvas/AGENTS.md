...
- In the list, "Starred"/"Spaces" are headings, not parents: under the layout
  the rows sit at the heading's level (no indent) and the cube/lock glyph belongs
  to the rows. The alpha's indented Channels tree and hash glyphs are unchanged.
