...
interface TaskState {
  ...
  moveTask: (taskId: string, fromIndex: number, toIndex: number, allTasks: Task[]) => void;
  setDraggedTaskId: (taskId: string | null) => void;
  setDragOverState: (index: number | null, position: "top" | "bottom" | null) => void;
  clearDragState: () => void;
...
export const useTaskStore = create<TaskState>()(
  ...
  moveTask: (taskId: string, fromIndex: number, toIndex: number, allTasks: Task[]) => {
  ...
  setDragOverState: (index: number | null, position: "top" | "bottom" | null) => {
