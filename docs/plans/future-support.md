...
Recommended next step: cut PR 1 and PR 2 together (flag + attention queue —
standalone value, zero posthog-side dependencies), and open PR 4a in
posthog/posthog in parallel so the migration lands before PR 4 needs it.
